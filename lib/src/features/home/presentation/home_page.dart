...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _HomeView(currentUser: currentUser),
    );
  }
}

class _HomeView extends StatelessWidget {
  const _HomeView({required this.currentUser});

  final AuthUser currentUser;

  @override
  Widget build(BuildContext context) {
    return BlocListener<SaloonActionCubit, SaloonActionState>(
            ...
            child: Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Text(
                    'Create a saloon or join one below. Your final role is decided by the action you take.',
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: 24),
                  const _BarberSaloonActions(),
                ],
              ),
            ),
          ),
...
class _BarberSaloonActions extends StatefulWidget {
  const _BarberSaloonActions();

  @override
  State<_BarberSaloonActions> createState() => _BarberSaloonActionsState();
}

class _BarberSaloonActionsState extends State<_BarberSaloonActions> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<SaloonActionCubit, SaloonActionState>(
      builder: (context, state) {
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Create a new saloon or join an existing one using hash code.',
              style: Theme.of(context).textTheme.bodyMedium,
            ),
